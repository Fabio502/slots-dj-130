...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-c2d510ba');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-c2d510ba');}
...
var brandEl=document.querySelector('.rl-brand-c2d510ba');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
